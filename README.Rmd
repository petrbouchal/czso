...
The goal of czso is to provide direct, programmatic hassle-free access to open data provided by the Czech Statistical Office (CZSO).
...
2. **providing a function to load a specific dataset to R** directly from the CZSO's datastore, eliminating the need to copy a URL, unzip etc.
